...
getData('/posts')
  .then(data => console.log('#1 Result(getData):', data))
...
postData('/posts', { title: 'foo', body: 'bar', userId: 3 })
  .then(data => console.log('#2 Result(postData):', data))
  .catch(error => console.error('Error:', error));
...
putData(12, { title: 'foo', body: 'bar', userId: 5 })
  .then(data => console.log('#3 Result(putData):', data))
  .catch(error => console.error('Error:', error));
...
patchData(6, { title: 'foo', body: 'bar', userId: 52 })
  .then(data => console.log('#4 Result(patchData):', data))
  .catch(error => console.error('Error:', error));
...
deleteData(22)
  // .then(data => console.log('#5 Result(deleteData):', data))
  // .catch(error => console.error('Error:', error));
